...
const CreateProjectComponent: React.FC<CreateProjectComponentProps> = ({
    ...
    const [formData, setFormData] = useState({ ...Project, ownerId: "" });
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        e.preventDefault();
        try {
            await axios.patch(`http://localhost:8080/project/${formData.id}`, formData);
    ...
    const closeModal = () => {
        setProjectInfo({ id: "", name: "", description: "", startDate: new Date("2020-09-12"), endDate: new Date("2020-09-12") });
